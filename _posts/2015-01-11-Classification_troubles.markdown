...
---------------------------------------------
![Adding a class to the node group][Add_class_groups_00.png]

As soon as the GUI finds the module in the modulepath, the *add class* button comes active.  Motd is only in ther thias environment, thats why I created the *thias testing* node group with environment *thias*.

![Class is added, waiting commit][Add_class_groups_01.png]

![Error message commit][Add_class_groups_02.png]

    Error saving group: The group being edited or created makes reference to the following missing classes: "motd" class in the "agent-specified" environment. See the `details` key for complete information on where each reference to a missing class originated. 


![When trying to leave the screen][Add_class_groups_03.png]
...
[Add_class_groups_00.png]: {{ site.url }}/images/Add_class_groups_01.png "Adding a class to the node group"
[Add_class_groups_01.png]: {{ site.url }}/images/Add_class_groups_01.png "Class is added, waiting commit"
[Add_class_groups_02.png]: {{ site.url }}/images/Add_class_groups_02.png "Error message commit"
[Add_class_groups_03.png]: {{ site.url }}/images/Add_class_groups_03.png "When trying to leave the screen"
